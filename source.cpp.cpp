...
int main(int argc, char *argv[])
{
    ...
    if ((dir = opendir(argv[1])) != nullptr)
    {
        ...
        while (true)
        {
            ...
            {
//                DIR *dir3;
//                struct dirent *diread3;
//                if ((dir3 = opendir(argv[1])) != nullptr)
//                {
//
//                    map<string, string> index3;
//                    set<string> current3;
//                    string index_path3 = string(argv[1]) + "\\index.txt";
//
//                    ifstream fin6(index_path3);
//
//                    if (fin6)
//                    {
//                        string line8;
...
//                            {
//                                getline(fin6, line8);
//                                if (line8.find("Novel") != std::string::npos)
//                                {
//                                    int pos3 = line8.find("Novel");
//                                    index3[line8.substr(0, --pos3)] = "Novel";
//                                }
//                                else if (line8.find("Play") != std::string::npos)
//                                {
//                                    int pos = line8.find("Play");
//                                    index3[line8.substr(0, --pos)] = "Play";
//                                }
//                            }
//                        }
//                        fin6.close();
//                    }
//
//                    bool new_books3 = true;
//
//                    while ((diread3 = readdir(dir3)) != nullptr)
//                    {
//                        if ((diread3->d_name)[0] != '.')
//                        {
//                            string file_name3 = diread3->d_name;
//                            int n3 = file_name3.length();
//                            string ext3 = file_name3.substr(n3 - 3);
//
//                            if (n3 > 4 && ext3 == "txt")
//                            {
//                                string filepath3 = string(argv[1]) + "\\" + diread3->d_name;
//                                ifstream fp3(filepath3);
//
//                                if (fp3)
//                                {
//                                    string line11;
...
//                                    {
//                                        getline(fp3, line11);
//                                        if (line11.length() && line11.find("Title: ") != std::string::npos)
//                                        {
//                                            string title3 = line11.substr(7, line11.length() - 7);
//                                            if (index3.find(title3) == index3.end())
//                                            {
//                                                if (new_books3)
//                                                {
//                                                    cout << "New books are detected!Please enter required details:\n";
//                                                    new_books3 = false;
//                                                }
//                                                cout << "Enter the type of the book " << title3 << ":";
//                                                string type3;
//                                                cin >> type3;
//                                                index3[title3] = type3;
//                                            }
//
//                                            current3.insert(title3);
//                                            break;
//                                        }
//                                    }
//                                }
...
//                    closedir(dir3);
//
//                    ofstream f_index3(index_path3);
//
//                    if (f_index3)
//                    {
//                        for (auto itr = index3.begin(); itr != index3.end();)
//                        {
//                            if (current3.count(itr->first))
//                            {
//                                f_index3 << itr->first << ' ' << itr->second << '\n';
//                                itr++;
//                            }
//                            else
//                                itr = index3.erase(itr);
//                        }
//                        f_index3.close();
//                    }
//                    else
